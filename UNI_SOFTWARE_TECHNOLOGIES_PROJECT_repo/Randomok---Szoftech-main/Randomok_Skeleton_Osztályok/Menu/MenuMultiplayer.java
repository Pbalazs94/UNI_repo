...
public class MenuMultiplayer extends Screen implements IUpdateable 
{

	private static final BufferedImage BG = Imaging.scale(Resources.images().get("multipalyerbg.png"), Game.window().getWidth(), Game.window().getHeight());
	...
	private Menu IconPress;
	  public MenuMultiplayer() 
	  {
		  ...
		  protected void initializeComponents() 
		  {
		    ...
		    this.OptBack = new Menu(startX - buttonWidth / 2, startY1 * 1.3, buttonWidth, startY1 / 2, "New Lobby");
		    this.OptBack = new Menu(startX - buttonWidth / 2, startY1 * 1.3, buttonWidth, startY1 / 2, "Find player");
		    this.OptBack = new Menu(startX - buttonWidth / 2, startY1 * 1.3, buttonWidth, startY1 / 2, "Friend list");
